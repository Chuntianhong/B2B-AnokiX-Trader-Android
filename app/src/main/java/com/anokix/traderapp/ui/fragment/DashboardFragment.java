...
import com.anokix.traderapp.ui.views.DonutChartView;
import com.anokix.traderapp.ui.views.LineChartView;
import com.anokix.traderapp.ui.views.SparklineView;
...
public class DashboardFragment extends Fragment {
    ...
    private void onQuickAction(int target) {
        switch (target) {
            case -1: // Order Stock -> Marketplace
                startActivity(new Intent(requireContext(), com.anokix.traderapp.ui.MarketplaceActivity.class));
                break;
            case -2: // Airtime & VAS
    ...
    private void buildTopProducts(View view) {
        ...
        list.removeAllViews();
        LayoutInflater inflater = LayoutInflater.from(requireContext());
        List<com.anokix.traderapp.model.ListItem> products = MockData.getTopProducts();
        for (int i = 0; i < products.size(); i++) {
            com.anokix.traderapp.model.ListItem p = products.get(i);
    ...
    private void buildLowStock(View view) {
        ...
        list.removeAllViews();
        LayoutInflater inflater = LayoutInflater.from(requireContext());
        List<com.anokix.traderapp.model.ListItem> items = MockData.getLowStockAlerts();
        for (com.anokix.traderapp.model.ListItem it : items) {
